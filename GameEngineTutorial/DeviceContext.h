...
public:
	...
	void setTexture(const VertexShaderPtr& vertex_shader, const TexturePtr* textures, unsigned int num_textures);
	void setTexture(const PixelShaderPtr& pixel_shader, const TexturePtr* textures, unsigned int num_textures);
